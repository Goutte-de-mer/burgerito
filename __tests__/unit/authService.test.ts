...
describe('AuthService - Unit Tests', () => {
  ...
  describe('registerUser', () => {
    it('should register a user successfully', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(`${process.env.API_URL}/auth/register`, {
        method: 'POST',
    ...
    it('should throw error when registration fails', async () => {
      ...
      await expect(registerUser('Test', 'test@example.com', 'pass')).rejects.toThrow('Email already exists');
    });
  });
